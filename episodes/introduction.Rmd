...
This is a concept in the world of start-ups, which refers to the practice of trying things out at an early stage.  If it works already, great, but if it doesn't, then you can move on more quickly to something that might work better.

![Fail fast](https://media-exp1.licdn.com/dms/image/C5112AQHF73FRDvyMKg/article-cover_image-shrink_423_752/0/1520095833109?e=1675296000&v=beta&t=1El6SuTeRWRXDkLelgFhywuEX6Y_WJXSrHTZ_jkauRo)
